...
function(install_libarary target)
  install(TARGETS ${target} DESTINATION data/obs-plugins/${CMAKE_PROJECT_NAME})
    ...
    if(GUID_VAL_COUNT EQUAL 5)
      ...
      if(GUID_ACTUAL_HEX STREQUAL GUID_HEX)
        ...
        if(GUID_VALS_DATA1_LENGTH EQUAL 8
          ...
          set(${name}_GUID_VAL01
              ${GUID_VALS_DATA1}
              PARENT_SCOPE)
          set(${name}_GUID_VAL02
              ${GUID_VALS_DATA2}
              PARENT_SCOPE)
          set(${name}_GUID_VAL03
              ${GUID_VALS_DATA3}
              PARENT_SCOPE)
          ...
          set(${name}_GUID_VAL04
              ${GUID_VAL04}
              PARENT_SCOPE)
          set(${name}_GUID_VAL05
              ${GUID_VAL05}
              PARENT_SCOPE)
          set(${name}_GUID_VAL06
              ${GUID_VAL06}
              PARENT_SCOPE)
          set(${name}_GUID_VAL07
              ${GUID_VAL07}
              PARENT_SCOPE)
          set(${name}_GUID_VAL08
              ${GUID_VAL08}
              PARENT_SCOPE)
          set(${name}_GUID_VAL09
              ${GUID_VAL09}
              PARENT_SCOPE)
          set(${name}_GUID_VAL10
              ${GUID_VAL10}
              PARENT_SCOPE)
          set(${name}_GUID_VAL11
              ${GUID_VAL11}
              PARENT_SCOPE)
