...
public:
	CTransformFilter(__in_opt LPCTSTR, __inout_opt LPUNKNOWN,
			 REFCLSID clsid);
#ifdef UNICODE
	CTransformFilter(__in_opt LPCSTR, __inout_opt LPUNKNOWN,
			 REFCLSID clsid);
#endif
	~CTransformFilter();
	...
	virtual HRESULT CompleteConnect(PIN_DIRECTION direction,
					IPin *pReceivePin);
