...
{
	switch (mode){
		case ModeVideo:    return (char*)MAPPING_NAMEV;
		case ModeVideo2:   return (char*)MAPPING_NAMEV2;
		case ModeVideo3:   return (char*)MAPPING_NAMEV3;
		case ModeVideo4:   return (char*)MAPPING_NAMEV4;
		case ModeAudio:    return (char*)MAPPING_NAMEA;
		default:           return NULL;
	}
}
